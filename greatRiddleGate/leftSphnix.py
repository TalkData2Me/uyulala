...
def AddFeatures(asset=''):
    try:
        ...
        features = uyulala.DMI(df=features,windowSize=14)
        features = uyulala.DMI(df=features,windowSize=11)
        features = uyulala.DMI(df=features,windowSize=9)
        features = uyulala.DMI(df=features,windowSize=7)
        features = uyulala.DMI(df=features,windowSize=5)
        features = uyulala.DMI(df=features,windowSize=4)
        features = uyulala.DMI(df=features,windowSize=3)
        features = uyulala.DMI(df=features,windowSize=2)
